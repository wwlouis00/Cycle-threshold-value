...
class Ui_MainWindow(QtWidgets.QWidget):
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1061, 779)
        self.centralwidget = QtWidgets.QWidget(MainWindow)
        self.centralwidget.setObjectName("centralwidget")
        self.CT_chart = QtWidgets.QGraphicsView(self.centralwidget)
        self.CT_chart.setGeometry(QtCore.QRect(10, 6, 1041, 349))
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(580, 372, 471, 397))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(10, 510, 561, 169))
        ...
        self.gridLayout_3.addWidget(self.label_Threshold, 1, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.Input_N, 1, 4, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.label_N, 1, 2, 1, 1)
        self.label_N_2 = QtWidgets.QLabel(self.layoutWidget1)
        font = QtGui.QFont()
        font.setPointSize(15)
        font.setBold(True)
        font.setWeight(75)
        self.label_N_2.setFont(font)
        self.label_N_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_N_2.setObjectName("label_N_2")
        self.gridLayout_3.addWidget(self.label_N_2, 1, 3, 1, 1)
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(11, 373, 561, 111))
        ...
        self.gridLayout_2.addWidget(self.Input_file, 0, 0, 1, 5)
        self.Input_file_Cali = QtWidgets.QLineEdit(self.widget)
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.Input_file_Cali.setFont(font)
        self.Input_file_Cali.setObjectName("Input_file_Cali")
        self.gridLayout_2.addWidget(self.Input_file_Cali, 1, 0, 1, 5)
        ...
        self.gridLayout_2.addWidget(self.btn_openfile, 2, 0, 1, 1)
        self.btn_opencali = QtWidgets.QPushButton(self.widget)
        font = QtGui.QFont()
        font.setPointSize(14)
        font.setBold(True)
        font.setWeight(75)
        self.btn_opencali.setFont(font)
        self.btn_opencali.setStyleSheet("color: rgb(255, 170, 0);")
        self.btn_opencali.setObjectName("btn_opencali")
        self.gridLayout_2.addWidget(self.btn_opencali, 2, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_savefile, 2, 2, 1, 1)
        ...
        self.btn_resetfile.setStyleSheet("color: rgb(0, 0, 255);")
        self.btn_resetfile.setObjectName("btn_resetfile")
        self.gridLayout_2.addWidget(self.btn_resetfile, 2, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.btn_clean, 2, 4, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_N_2.setText(_translate("MainWindow", "="))
