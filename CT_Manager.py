...
# Form implementation generated from reading ui file 'CT_Manager.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.MplWidget.setGeometry(QtCore.QRect(40, 6, 661, 193))
        self.MplWidget.setObjectName("MplWidget")
        self.Input_file = QtWidgets.QLineEdit(self.centralwidget)
        self.Input_file.setGeometry(QtCore.QRect(10, 204, 261, 25))
        font = QtGui.QFont()
        font.setPointSize(8)
        font.setBold(False)
        font.setWeight(50)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(280, 204, 201, 31))
        ...
        self.groupBox.setGeometry(QtCore.QRect(10, 228, 261, 145))
        self.groupBox.setCheckable(True)
        self.groupBox.setObjectName("groupBox")
        self.layoutWidget_2 = QtWidgets.QWidget(self.groupBox)
        self.layoutWidget_2.setGeometry(QtCore.QRect(10, 18, 241, 115))
        self.layoutWidget_2.setObjectName("layoutWidget_2")
        self.gridLayout_3 = QtWidgets.QGridLayout(self.layoutWidget_2)
        self.gridLayout_3.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.A8_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.Clear_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.A7_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.A2_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.A5_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.A3_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.A4_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.A6_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.All_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.A1_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.B1_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.B2_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.B3_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.B4_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.B5_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.B6_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.B7_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.B8_radio = QtWidgets.QRadioButton(self.layoutWidget_2)
        ...
        self.layoutWidget_3.setGeometry(QtCore.QRect(280, 246, 201, 115))
        ...
        self.slider_threshold = QtWidgets.QSlider(self.layoutWidget_3)
        ...
        self.ns_threshold = QtWidgets.QLCDNumber(self.layoutWidget_3)
        self.ns_threshold.setObjectName("ns_threshold")
        self.gridLayout.addWidget(self.ns_threshold, 0, 2, 1, 1)
        self.baseline_begin = QtWidgets.QLabel(self.layoutWidget_3)
        ...
        self.slider_begin = QtWidgets.QSlider(self.layoutWidget_3)
        ...
        self.ns_baseline_begin = QtWidgets.QLCDNumber(self.layoutWidget_3)
        self.ns_baseline_begin.setObjectName("ns_baseline_begin")
        self.gridLayout.addWidget(self.ns_baseline_begin, 1, 2, 1, 1)
        self.baseline_end = QtWidgets.QLabel(self.layoutWidget_3)
        ...
        self.slider_end = QtWidgets.QSlider(self.layoutWidget_3)
        ...
        self.ns_baseline_end = QtWidgets.QLCDNumber(self.layoutWidget_3)
        self.ns_baseline_end.setObjectName("ns_baseline_end")
        self.gridLayout.addWidget(self.ns_baseline_end, 2, 2, 1, 1)
        self.tableWidget = QtWidgets.QTableWidget(self.centralwidget)
        self.tableWidget.setGeometry(QtCore.QRect(490, 204, 211, 157))
